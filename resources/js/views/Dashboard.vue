  ...
  <div>
    <div class="d-sm-flex justify-content-between mb-4">
      <span style="font-weight: bold">
        ...
        ></span>
        <a-badge :count="Wallet.exchange" :number-style="{ backgroundColor: '#6C757D' }" />
        ...
        <span
          ...
          ><i class="fa fa-info-circle" aria-hidden="true"></i
        ></span>
        <a-badge :count="Withdrawal.exchange" :number-style="{ backgroundColor: '#6C757D' }" />
        <a-badge :count="Withdrawal.amount" :number-style="{ backgroundColor: '#6C757D' }" />
      </span>
    </div>
    <br />
    <!-- Counter Widgets -->
...
export default {
  ...
  methods: {
    ...
    async callItems() {
      this.isLoading = true;
      var titles = this.stats.map(function(stat){return stat.title});
      let { data } = await axios.post("dashboard/items", {names: titles});
